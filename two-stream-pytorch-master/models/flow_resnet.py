...
import collections
import numpy as np
import models.feafa_architecture
...
class FlowOnlyClassifier(nn.Module):
    def __init__(self, flow_generator,
        ...
        checkpoint = torch.load('/home/wangccy/twostream_feafa/saved2/epoch00005.ckp')
        flow_generator.load_state_dict(checkpoint['model_state_dict'])
        #print(self.flow_generator) 
